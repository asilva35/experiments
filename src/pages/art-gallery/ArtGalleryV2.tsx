        ...
        <div style={{ position: 'fixed', top: 22, right: 32, zIndex: 110 }}>
            ...
            <div
                ...
                {[0, 1, 2, 3, 4].map((i) => (
                    <div
                        key={i}
                        className={`music-bar bar-${i + 1} ${isPlaying ? 'playing' : ''}`}
                        style={{
                            width: '3px',
                            background: '#c9a84c', // Using the gold accent color
                            borderRadius: '1.5px',
                            height: isPlaying ? 'auto' : '3px',
                            animation: isPlaying ? `musicWave 1s ease-in-out ${i * 0.15}s infinite` : 'none',
...
export default function ArtGallery() {
    ...
    const scrollBounceRef = useRef<number>(0)
    ...
    }, [isExploring, isTransitioning, handleNextManual, handlePrevManual])
    ...
    return (
        ...
        .music-bar.playing {
            /* Handled by inline style for height animation usually, but we define the keyframes here */
        }
                        ...
                        <div style={{ marginTop: '25px' }}>
                            <button
                                ...
                                onMouseLeave={e => {
                                    ...
                                    e.currentTarget.style.color = '#a08a5a'
                                }}
                            >
                                Begin without music
                            </button>
